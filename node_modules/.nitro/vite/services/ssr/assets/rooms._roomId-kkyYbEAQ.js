import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-D06zludD.js";
import { i as createServerFn, p as TSS_SERVER_FUNCTION } from "./esm-Dova13aH.js";
import { t as supabase } from "./client-Ca5S0WhP.js";
import { t as Route } from "./rooms._roomId-BkOBp3L0.js";
import { r as langName, t as LanguageSelect } from "./LanguageSelect-VRyeAIc7.js";
...
import { ArrowLeft, BookOpen, Copy, Download, Eye, FileText, LogOut, Paperclip, Send, Settings, Smile, Users, X } from "lucide-react";
...
//#endregion
//#region src/lib/translate.functions.ts
...
var DetectSchema = z.object({ text: z.string().min(1).max(2e3) });
...
//#endregion
//#region src/components/chat/ReactionBar.tsx
var EMOJIS = [
	"👍",
	"❤️",
	"😂",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [Object.entries(reactions).filter(([, s]) => s.size > 0).map(([emoji, users]) => {
			...
			children: [/* @__PURE__ */ jsx("button", {
				...
				children: /* @__PURE__ */ jsx(Smile, { size: 13 })
				...
				children: EMOJIS.map((e) => /* @__PURE__ */ jsx("button", {
					onClick: () => toggle(e),
...
//#endregion
//#region src/components/chat/FilePreview.tsx
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					!loading && kind === "image" && imageUrl && /* @__PURE__ */ jsx("img", {
						src: imageUrl,
						alt: attachment.name,
						className: "max-w-full mx-auto"
					}),
					!loading && kind === "text" && content !== null && /* @__PURE__ */ jsx("pre", {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				body.trim().length > 0 && /* @__PURE__ */ jsx("div", {
				...
				atts.length > 0 && /* @__PURE__ */ jsx("div", {
					className: "flex flex-col gap-1.5",
					children: atts.map((a, i) => /* @__PURE__ */ jsx(FilePreview, { attachment: a }, i))
				}),
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						isMine && typeof readCount === "number" && readCount > 0 && /* @__PURE__ */ jsxs("span", {
						...
						needsTranslate && /* @__PURE__ */ jsxs(Fragment, { children: [translating && /* @__PURE__ */ jsx("span", {
							className: "italic",
							children: "translating…"
						}), translated && !translating && /* @__PURE__ */ jsxs(Fragment, { children: [
...
//#endregion
//#region src/components/chat/EventRow.tsx
...
//#endregion
//#region src/components/chat/RulesModal.tsx
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						!showAccept && onClose && /* @__PURE__ */ jsx("button", {
							onClick: onClose,
							className: "px-3 py-2 text-sm hover:bg-surface-2 rounded-md",
							children: t("cancel")
						}),
						showAccept && /* @__PURE__ */ jsx("button", {
							onClick: onAccept,
...
//#endregion
//#region src/components/chat/RoomSettingsDialog.tsx
var COLORS = [
	"#3b82f6",
	"#10b981",
	"#f59e0b",
...
//#endregion
//#region src/routes/_authenticated/rooms.$roomId.tsx?tsr-split=component
...
function RoomPage() {
	...
	if (!room || !me) return /* @__PURE__ */ jsx("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("header", {
				...
				children: [
					...
					room.rules && /* @__PURE__ */ jsx("button", {
						onClick: () => {
					...
					/* @__PURE__ */ jsx(LanguageSelect, { persist: true }),
					/* @__PURE__ */ jsx("button", {
						onClick: leaveRoom,
			...
			room.announcement && /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx("main", {
				...
				children: timeline.length === 0 ? /* @__PURE__ */ jsx("p", {
					...
					children: [timeline.map((it) => {
						...
						prevDay = dayLabel;
						return /* @__PURE__ */ jsxs("div", { children: [showDate && dayLabel && /* @__PURE__ */ jsx(DateDivider, { label: dayLabel }), it.kind === "message" ? /* @__PURE__ */ jsx(MessageItem, {
							message: it.data,
			...
			/* @__PURE__ */ jsx(TypingIndicator, { names: typingNames }),
			/* @__PURE__ */ jsx("footer", {
			...
			showRules && room.rules && /* @__PURE__ */ jsx(RulesModal, {
				rules: room.rules,
			...
			showSettings && /* @__PURE__ */ jsx(RoomSettingsDialog, {
				room,
