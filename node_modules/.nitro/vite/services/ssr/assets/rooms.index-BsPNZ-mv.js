...
import { t as LanguageSelect } from "./LanguageSelect-VRyeAIc7.js";
...
//#region src/routes/_authenticated/rooms.index.tsx?tsr-split=component
function RoomsPage() {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: t("loading")
				}) : rooms.length === 0 ? /* @__PURE__ */ jsxs("div", {
					...
					children: rooms.map((r) => /* @__PURE__ */ jsxs("button", {
						onClick: () => joinRoom(r),
			...
			showNew && /* @__PURE__ */ jsx(NewRoomDialog, {
